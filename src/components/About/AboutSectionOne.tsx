              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    ...
                    <List text="Specialized Courses" />

                  </div>

                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="One-on-One Tutoring" />
                    <List text="Homework Help" />
                    <List text="Exam Preparation" />
                  </div>
                </div>
              </div>
            </div>
